...
public class CustomerProcessor implements ResourceProcessor<Resource<Customer>> {
	...
	/* 
	 * (non-Javadoc)
	 * @see org.springframework.hateoas.ResourceProcessor#process(org.springframework.hateoas.Resource, java.lang.Object)
	 */
	@Override
	public Resource<?> process(Resource<Customer> resource) {
